...
public class ColorTypeEvaluator implements TypeEvaluator {
    ...
    public Object evaluate(float fraction, Object startValue, Object endValue) {
        ...
        if (mCurrentRed!=endRed){
            mCurrentRed = getCurrentColorr(startRed,endRed,colorDiff,0,fraction);
        }else if(mCurrentGreen !=endGreen){
            mCurrentGreen = getCurrentColorr(startGreen,endGreen,colorDiff,redDiff,fraction);
        }else if(mCurrentBlue !=endBlue){
            mCurrentBlue = getCurrentColorr(startBlue,endBlue,colorDiff,redDiff+greenDiff,fraction);
        }
    ...
    private int getCurrentColorr(int startColor, int endColor, int colorDiff,
